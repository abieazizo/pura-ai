...
const DEVICE_TEST_KIT_TEXT = [
  'DEVICE VERIFICATION KIT — v19.41',
  '',
  'TEST 0 — confirm v19.41 is actually running (do this FIRST)',
  '──────────────────────────────────────────────────',
  '  1. Open the Products tab.',
  '  2. Type ANY query (e.g. "moisturizer").',
  '  3. Wait for the result grid to appear.',
  '  PASS:',
  '    • A yellow "REAL PATH v19.41" pill is visible directly',
  ...
  '  FAIL:',
  '    • No "REAL PATH v19.41" pill visible',
  '    • OR rerankPromptVersion shows anything other than',
  '      "v19.41-exact-hard-filter"',
  '    • If FAIL, the v19.41 bundle is NOT running on your device.',
  ...
  'OVERALL FAIL:  TEST 0 fails (v19.41 not active),',
