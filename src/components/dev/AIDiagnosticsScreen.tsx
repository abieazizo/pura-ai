...
const DEVICE_TEST_KIT_TEXT = [
  'DEVICE VERIFICATION KIT — v19.42',
  '',
  'TEST 0 — confirm v19.42 is actually running (do this FIRST)',
  '──────────────────────────────────────────────────',
  '  1. Open the Products tab.',
  '  2. Type ANY query (e.g. "moisturizer").',
  '  3. Wait for the result grid to appear.',
  '  PASS:',
  '    • A yellow "REAL PATH v19.42" pill is visible directly',
  ...
  '  FAIL:',
  '    • No "REAL PATH v19.42" pill visible',
  '    • OR rerankPromptVersion shows anything other than',
  '      "v19.41-exact-hard-filter"',
  '    • If FAIL, the v19.42 bundle is NOT running on your device.',
  ...
  '',
  '──────────────────────────────────────────────────',
  'TEST 17 — AI rerank actually runs (v19.42)',
  '──────────────────────────────────────────────────',
  ...
  '      gray — v19.42 was supposed to make this impossible)',
  ...
  '',
  '──────────────────────────────────────────────────',
  'TEST 18 — different users get different heroes (v19.42)',
  '──────────────────────────────────────────────────',
  ...
  '',
  '──────────────────────────────────────────────────',
  'OVERALL PASS:  TEST 0 passes AND every TEST 1-18 passes.',
  'OVERALL FAIL:  TEST 0 fails (v19.42 not active),',
