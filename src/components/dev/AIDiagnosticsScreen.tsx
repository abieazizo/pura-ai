...
const DEVICE_TEST_KIT_TEXT = [
  'DEVICE VERIFICATION KIT — v19.40',
  '',
  'TEST 0 — confirm v19.40 is actually running (do this FIRST)',
  '──────────────────────────────────────────────────',
  '  1. Open the Products tab.',
  '  2. Type ANY query (e.g. "moisturizer").',
  '  3. Wait for the result grid to appear.',
  '  PASS:',
  '    • A yellow "REAL PATH v19.40" pill is visible directly',
  '      ABOVE the result grid, with these lines:',
  '        rerankPromptVersion = v19.40-exact',
  ...
  '  FAIL:',
  '    • No "REAL PATH v19.40" pill visible',
  '    • OR rerankPromptVersion shows anything other than',
  '      "v19.40-exact"',
  '    • If FAIL, the v19.40 bundle is NOT running on your device.',
  ...
  '',
  '──────────────────────────────────────────────────',
  'TEST 14 — exactly 6 first, +6 on scroll (v19.40)',
  '──────────────────────────────────────────────────',
  ...
  '',
  '──────────────────────────────────────────────────',
  'TEST 15 — image quality tier (v19.40)',
  '──────────────────────────────────────────────────',
  ...
  '',
  '──────────────────────────────────────────────────',
  'TEST 16 — picks feel personal, not random (v19.40)',
  '──────────────────────────────────────────────────',
  ...
  '',
  '──────────────────────────────────────────────────',
  'OVERALL PASS:  TEST 0 passes AND every TEST 1-16 passes.',
  'OVERALL FAIL:  TEST 0 fails (v19.40 not active),',
