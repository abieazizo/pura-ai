...
const DEVICE_TEST_KIT_TEXT = [
  'DEVICE VERIFICATION KIT — v19.38',
  '',
  'TEST 0 — confirm v19.38 is actually running (do this FIRST)',
  '──────────────────────────────────────────────────',
  '  1. Open the Products tab.',
  '  2. Type ANY query (e.g. "moisturizer").',
  '  3. Wait for the result grid to appear.',
  '  PASS:',
  '    • A yellow "REAL PATH v19.38" pill is visible directly',
  '      ABOVE the result grid, with the lines:',
  '        queryFamily, skinFitReason, heroSkinFitScore,',
  '        resultSource, lastUpdatedAt',
  '  FAIL:',
  '    • No "REAL PATH v19.38" pill visible',
  '    • If FAIL, the v19.38 bundle is NOT running on your device.',
  ...
  '',
  '──────────────────────────────────────────────────',
  'OVERALL PASS:  TEST 0 passes AND every TEST 1-13 passes.',
  'OVERALL FAIL:  TEST 0 fails (v19.38 not active),',
