...
const DEVICE_TEST_KIT_TEXT = [
  'DEVICE VERIFICATION KIT — v19.43',
  '',
  'TEST 0 — confirm v19.43 is actually running (do this FIRST)',
  '──────────────────────────────────────────────────',
  '  1. Open the Products tab.',
  '  2. Type ANY query (e.g. "moisturizer").',
  '  3. Wait for the result grid to appear.',
  '  PASS:',
  '    • A yellow "REAL PATH v19.43" pill is visible directly',
  ...
  '  FAIL:',
  '    • No "REAL PATH v19.43" pill visible',
  '    • OR rerankPromptVersion shows anything other than',
  '      "v19.41-exact-hard-filter"',
  '    • If FAIL, the v19.43 bundle is NOT running on your device.',
  ...
  '',
  '──────────────────────────────────────────────────',
  'TEST 17 — AI rerank actually runs (v19.43)',
  '──────────────────────────────────────────────────',
  ...
  '      gray — v19.43 was supposed to make this impossible)',
  ...
  '',
  '──────────────────────────────────────────────────',
  'TEST 18 — different users get different heroes (v19.43)',
  '──────────────────────────────────────────────────',
  ...
  '',
  '──────────────────────────────────────────────────',
  'TEST 19 — AI-first product planner is the recommendation engine (v19.43)',
  '──────────────────────────────────────────────────',
  ...
  '',
  '──────────────────────────────────────────────────',
  'TEST 20 — best-for-you is genuinely user-specific (v19.43)',
  '──────────────────────────────────────────────────',
  ...
  '',
  '──────────────────────────────────────────────────',
  'OVERALL PASS:  TEST 0 passes AND every TEST 1-20 passes.',
  'OVERALL FAIL:  TEST 0 fails (v19.43 not active),',
